namespace PrimS.Telnet
{
  ...
  public partial class Client
  {
    ...
    public Client(string hostname, int port)
      : this(new TcpByteStream(hostname, port))
    {
    }
    ...
    public Client(IByteStream byteStream)
      : this(byteStream, new TimeSpan(0, 0, 30), ConnectionMode.OnInitialise)
    {
    }
    ...
    public Client(IByteStream byteStream, TimeSpan timeout, ConnectionMode connectionMode)
      : base(byteStream)
    {
